...
RUN reflector --verbose --protocol "https,http" --latest 10 --sort rate --save /etc/pacman.d/mirrorlist
RUN pacman -S --noconfirm base base-devel pacman-contrib git sudo
